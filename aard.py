...
def main():
    ...
    print("Horizon coordinates: {0}".format(altAz))
...
def checkAltAz(rawAltAz):
    ...
    try:
        ...
        usage("Azimuth '{0}' should have the form "
                "'NNNd[NNm[NN.NNNs]]'.".format(rawAz))
    ...
    try:
        ...
        usage("Altitude '{0}' should have the form "
                "'NNd[NNm[NN.NNNs]]'.".format(rawAlt))
